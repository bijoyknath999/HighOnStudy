...
public class QuestionPaperFragment extends Fragment implements SearchView.OnQueryTextListener{
    ...
    public void loadSearchedPosts(boolean Scrolled,String searchText) {
        ApiUtils.getApiInterface().getSearchedPosts(131,pageCount, searchText).enqueue(new Callback<List<Post>>() {
            @Override

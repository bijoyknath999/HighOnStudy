...
public class AdmitCardFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public void loadSearchedPosts(boolean Scrolled,String searchText) {
        ApiUtils.getApiInterface().getSearchedPosts(145,pageCount, searchText).enqueue(new Callback<List<Post>>() {
            @Override

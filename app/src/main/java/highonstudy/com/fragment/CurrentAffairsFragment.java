...
public class CurrentAffairsFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public void loadSearchedPosts(boolean Scrolled,String searchText) {
        ApiUtils.getApiInterface().getSearchedPosts(273,pageCount, searchText).enqueue(new Callback<List<Post>>() {
            @Override

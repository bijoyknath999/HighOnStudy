...
public class GridJobPublicSCAdapter extends RecyclerView.Adapter<GridJobPublicSCAdapter.ViewHolder> {

    private final List<gridjobByL_items> grid_items;
    private final Context context;

    public GridJobPublicSCAdapter(Context context, List<gridjobByL_items> grid_itemsList) {
    ...
    @Override
    public void onBindViewHolder(GridJobPublicSCAdapter.ViewHolder mainHolder, int position) {
